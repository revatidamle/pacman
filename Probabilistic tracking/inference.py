    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for old in self.legalPositions:
            newDistribution = self.getPositionDistribution(self.setGhostPosition(gameState, old))
            for newPosition, newProb in newDistribution.items():
                allPossible[newPosition] += newProb * self.beliefs[old]
